...
- 物品被提到，不等于主角已经取得或失去；
- 人物要求递入或用某件物品核验，不等于物品已经递入，也不等于该办法已被证明是唯一、可靠的身份判据；
- 单据、承诺、申请或提出资源转移要求，不等于对应资源已经转移；
- 准备、尝试、维持或加固某项动作，不等于目标状态已经完成；
- 人物离开一处，不等于已到达计划地点；
- 时间氛围变化，不等于可以推出精确累计天数；
- 伏笔 ID 和里程碑 ID 不会出现在正文；依据候选的 `meaning` 判断其叙事内容是否已有可引用落点；
- 大纲标题、章旨和钩子文案不能直接进入状态。

`reader_visible_summary.core` 用 8—160 个中文字符概括本章真正发生的行动、核心事件与后果，并提供至少两条正文逐字证据。摘要不得写入大纲意图、未证实规则或人物没获得的信息。
