...
- 先确定张洞眼前想得到什么、失去它会怎样，再确定他必须亲自作出的选择及代价。该选择必须造成、触发或显著增加本章不可逆转折的风险；不能让张洞只负责旁观、检查、记录，而由长辈完成全部关键决定。
- 开篇从目标已经受到阻碍、交易正在失败、关系正在逼迫或异常已经打断日常的时刻进入。不要先用库存、交通、历史或世界知识预热；这些信息只能在人物为眼前目标行动时抵达。
